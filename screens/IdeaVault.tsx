import { View, Text, StyleSheet, TouchableOpacity, Modal, TextInput, ActivityIndicator, Dimensions, ScrollView, Image, Button } from 'react-native';
...
export default function IdeaVault({ navigation }: IdeaVaultProps) {
  ...
  const handleDragMove = (id: string, x: number, y: number) => {
    ...
    physicsEngineRef.current?.updateCardRotation(id, 0);
    physicsEngineRef.current?.pausePhysicsUpdates(id);
  };
